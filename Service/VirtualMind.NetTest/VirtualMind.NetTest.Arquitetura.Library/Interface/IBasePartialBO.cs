...
{
    /// <summary>
    /// Define métodos de regras de negócios dos objetos para tabelas com chave compostas (sem colunas adicionais).
    /// Os métodos de Update, ListForGrid e SelectByPK são removidos.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <typeparam name="ID"></typeparam>
    public interface IBasePartialBO<T, ID> : IDisposable
    {
